...
console.log(array[1]);//element of the first in the array

console.log(array[array.length-1]);//second last element
...
console.log(`====== splice() =========`);
var arrayNumber5 = [22, 11, 44, 55, 77, 33];
...
console.log(`traversing array in for in loop`);
...
var arrayNumber5 = [22, 11, 44, 55, 77, 33];// [22, 11, 44]
